...
if (isset($_GET['id'])) {
    ...
    $select_assessment_data = "SELECT * FROM assessments WHERE assessment_id = '$get_assessment_id'";
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm" name="assessment_id[]" value="<?= htmlspecialchars($assessment['assessment_id']); ?>" readonly>
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm" name="student_id[]" value="<?= htmlspecialchars($student['student_id']); ?>" readonly>
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" name="obtain_marks[]" class="form-control form-control-sm" required>
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" class="form-control form-control-sm" value="100" readonly>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                            }
