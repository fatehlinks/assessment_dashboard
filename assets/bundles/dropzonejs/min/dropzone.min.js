          ...
          value: function () {
            (this.prototype.Emitter = Emitter),
              ...
              (this.prototype.defaultOptions = {
                ...
                primary: function (a) {
                  if (a.previewElement)
                    return a.previewElement.classList.add("dz-primary");
                },
                primarymultiple: function () {},
                canceled: function (a) {
          ...
          },
          {
            ...
            value: function (a, c, d) {
              for (var e = a, f = 0, e = e; ; ) {
                ...
                var h = g;
                (h.status = b.primary),
                  this.emit("primary", h, c, d),
                  this.emit("complete", h);
              }
              if (
                (this.options.uploadMultiple &&
                  (this.emit("primarymultiple", a, c, d),
