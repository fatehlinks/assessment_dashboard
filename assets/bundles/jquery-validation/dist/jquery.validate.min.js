    ...
    a.extend(a.validator, {
      ...
      prototype: {
        ...
        showErrors: function (b) {
          if (b) {
            ...
            a.extend(this.errorMap, b),
              ...
              (this.primaryList = a.grep(this.primaryList, function (a) {
                return !(a.name in b);
              }));
          }
        ...
        check: function (b) {
          ...
          if (!i) return this.objectLength(g) && this.primaryList.push(b), !0;
        },
        ...
        defaultShowErrors: function () {
          ...
          if (
            ...
            for (a = 0; this.primaryList[a]; a++)
              this.showLabel(this.primaryList[a]);
          if (this.settings.unhighlight)
        ...
        showLabel: function (b, c) {
          ...
          h.length
            ...
            !c &&
              this.settings.primary &&
              (h.text(""),
              "string" == typeof this.settings.primary
                ? h.addClass(this.settings.primary)
                : this.settings.primary(h, b)),
