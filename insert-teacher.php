...
if (isset($_POST['add-teacher-btn'])) {
    ...
    $add_teacher_qry = "INSERT INTO teachers (teacher_name, teacher_cnic, teacher_mobile, teacher_subject, teacher_status) 
                        VALUES ('$teacher_name', '$teacher_cnic', '$teacher_mobile', '$teacher_subject' , '$teacher_status')";
